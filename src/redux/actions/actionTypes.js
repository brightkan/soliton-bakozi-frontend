...
// Soliton Users
export const LOAD_SOLITON_USERS_SUCCESS = 'LOAD_SOLITON_USERS_SUCCESS';
export const CREATE_SOLITON_USER_SUCCESS = 'CREATE_SOLITON_USER_SUCCESS';
export const UPDATE_SOLITON_USER_SUCCESS = 'UPDATE_SOLITON_USER_SUCCESS';
export const DELETE_SOLITION_USER_OPTIMISTIC = 'DELETE_SOLITON_USER_OPTIMISTIC';
